      ...
      <div className="container-x grid grid-cols-1 gap-10 py-14 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="flex items-center gap-3">
            <Image src={company.logo || "/images/logo.jpeg"} alt={company.name} width={48} height={48} className="h-12 w-auto rounded-lg bg-white p-1" />
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3.5 text-sm">
            <li className="flex gap-3"><MapPin className="h-5 w-5 flex-none text-brand-yellow" /><span className="text-white/60">{address}</span></li>
