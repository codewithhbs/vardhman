              ...
              {[
                {
                  icon: MapPin,
                  t: "Address",
                  v: `Ground Floor, Front Portion, Khasra No 71/1 Min, Alipur, Karnal Road, Central Delhi, New Delhi - 110036, Delhi, India`,
                },
                {
                  icon: Phone,
                  t: "Phone",
                  v: `${company.phone} · ${company.phone2}`,
                },
                ...
                <div
                  key={c.t}
                  className="flex items-start gap-4 rounded-2xl border border-black/5 bg-white p-5 shadow-card"
                >
