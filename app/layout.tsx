...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Premium industrial tapes, foam and packaging solutions — engineered for quality, delivered on time.",
    images: [
      { url: "/images/logo.jpeg", width: 600, height: 600, alt: company.name },
    ],
  },
  twitter: {
